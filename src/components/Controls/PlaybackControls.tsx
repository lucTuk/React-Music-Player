...
export function PlaybackControls({
    ...
    return (
        <div className="flex items-center justify-center self-center bg-gray-light w-[97vw] h-[39vh] rounded-2xl">
            <div className="w-60 h-60 bg-white rounded-full relative before:absolute before:bg-gray-light before:min-w-2/5 before:h-2/5 before:rounded-full before:top-1/2 before:left-1/2 before:transform before:-translate-x-1/2 before:-translate-y-1/2 text-gray drop-shadow-md">
